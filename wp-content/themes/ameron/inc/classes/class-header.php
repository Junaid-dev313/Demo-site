<?php
if (!class_exists('Ameron_Header')) {
    class Ameron_Header
    {
        public function getHeader()
        {
            $remove_header        = (int)ameron()->get_opt('remove_header');
            if ($remove_header){
                return true;
            }
        ...
        public function get_header_css_class($args = []){
            ...
            $args = wp_parse_args($args, [
                'class'                => '',
                'header_layout'        => (int)ameron()->get_opt('header_layout','0'), 
                'header_transparent'         => ameron()->get_opt('header_transparent'),
                'header_sticky_layout' => (int)ameron()->get_opt('header_sticky_layout'),
                'header_mobile_layout' => (int)ameron()->get_opt('header_mobile_layout'),
                'header_mobile_transparent'  => ameron()->get_opt('header_mobile_transparent')
            ]);
