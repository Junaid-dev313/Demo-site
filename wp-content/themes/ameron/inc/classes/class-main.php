...
if (!class_exists('Ameron_Main')) {
    class Ameron_Main extends Ameron_Base
    {
...
function ameron() {
    return Ameron_Main::getInstance();
}
// Install
ameron(); 
