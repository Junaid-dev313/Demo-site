...
class Ameron_CSS_Generator {
	...
	function __construct() {
		$this->opt_name = ameron()->get_option_name();  
	...
	protected function get_options_output() {
        ...
        $links                           = ameron_configs('link');
        $body                            = ameron_configs('body');
        $header                          = ameron_configs('header');
        $heading                         = ameron_configs('heading');
        $heading_font_size               = ameron_configs('heading_font_size');
        $menu                            = ameron_configs('menu');
        $submenu                        = ameron_configs('dropdown');
        $mobile_menu                     = ameron_configs('mobile_menu');
        $mobile_submenu                  = ameron_configs('mobile_submenu');
        $border                          = ameron_configs('border');
        $divider                         = ameron_configs('divider');
        $logo                            = ameron_configs('logo');
        $button                          = ameron_configs('button');
