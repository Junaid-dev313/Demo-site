<?php  
function ameron_get_current_page_url() {
...
function ameron_woocommerce_query($type='recent_product',$post_per_page=-1,$product_ids='',$categories='',$param_args=[]){
    global $wp_query;
    ...
    if(!empty($product_ids)){
        ...
        $args = ameron_product_filter_type_args($type,$args);
    ...
    $pagination = get_the_posts_pagination(array(
        'screen_reader_text' => '',
        'mid_size' => 2,
        'prev_text' => esc_html__('Back', 'ameron'),
        'next_text' => esc_html__('Next', 'ameron'),
    ));
    global $paged;
    $paged = $pxl_paged; 
...
function ameron_product_filter_type_args($type,$args){
    switch ($type) {
        case 'best_selling':
