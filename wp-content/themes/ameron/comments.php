...
if ( post_password_required() )
    return;
$post_comment = ameron()->get_theme_opt('post_comments_on', '1');
    ...
    <div id="comments" class="<?php echo esc_attr($wrap_class);?>">
        ...
        if ( have_comments() ) : ?>
                ...
                <ol class="commentlist">
                    <?php
                        wp_list_comments( array(
                            'style'      => 'ul',
                            'short_ping' => true,
                            'callback'   => [ameron()->comment, 'comment_list'],
                            'max_depth'  => 3
                        ) );
                    ?>
                </ol>
            ...
            <?php if ( ! comments_open() ) : ?>
                <p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'ameron' ); ?></p>
            <?php
            endif;

        endif;
       
        comment_form(ameron()->comment->comment_form_args()); ?>
</div>
