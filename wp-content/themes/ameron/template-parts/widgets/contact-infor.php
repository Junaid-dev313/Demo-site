...
class PXL_Contact_Info_Widget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            ...
            esc_html__('* Pxl contact Information', 'ameron'),
            array('description' => esc_html__('Show contact Information', 'ameron'),)
        );
    }
    ...
    function widget($args, $instance)
    {
        ...
        <div class="pxl-contact-info widget" >
            <div class="content-inner">
                <div class="background-overlay-primary"></div>
                ...
                <div class="box-image" style="background-image: url(<?php echo esc_url($contact_image_url)?>);"></div>
            </div>
        </div>
        <?php
    }
    ...
    function form($instance)
    {
        ...
        ?>
        <div class="ameron-image-wrap">
            <label for="<?php echo esc_url($this->get_field_id('contact_image')); ?>"><?php esc_html_e('contact Image', 'ameron'); ?></label>
            ...
            if ($contact_image != "") {
                ?>
                <a href="#" class="pxl-select-image" style="display: none;"><?php esc_html_e('Select Image', 'ameron'); ?></a>
                <a href="#" class="pxl-remove-image"><?php esc_html_e('Remove Image', 'ameron'); ?></a>
                <?php
            } else {
                ?>
                <a href="#" class="pxl-select-image"><?php esc_html_e('Select Image', 'ameron'); ?></a>
                <a href="#" class="pxl-remove-image" style="display: none;"><?php esc_html_e('Remove Image', 'ameron'); ?></a>
                <?php
            }
            ?>
        </div>
        <p>
            <label for="<?php echo esc_url($this->get_field_id('contact_sub')); ?>"><?php esc_html_e( 'contact sub', 'ameron' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_url($this->get_field_id('contact_heading')); ?>"><?php esc_html_e( 'contact heading', 'ameron' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_url($this->get_field_id('description')); ?>"><?php esc_html_e('Description', 'ameron'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_url($this->get_field_id('button_text')); ?>"><?php esc_html_e('Button Text', 'ameron'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_url($this->get_field_id('button_link')); ?>"><?php esc_html_e('Button Link', 'ameron'); ?></label>
