...
class PXL_Author_Info_Widget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            ...
            esc_html__('* Pxl Author Information', 'ameron'),
            array('description' => esc_html__('Show Author Information', 'ameron'),)
        );
    }
            ...
            <div class="content-inner">
                <div class="author-image">
                    <div class="image-wrap flash-hover">
                        <img src="<?php echo esc_url($author_image_url)?>" alt="<?php echo esc_attr__('Author Image', 'ameron');?>">
                    </div>
                    <?php
    ...
    function form($instance)
    {
        ...
        <div class="ameron-image-wrap">
            <label for="<?php echo esc_url($this->get_field_id('author_image')); ?>"><?php esc_html_e('Author Image', 'ameron'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_url($this->get_field_id('author_position')); ?>"><?php esc_html_e( 'Author Position', 'ameron' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_url($this->get_field_id('author_name')); ?>"><?php esc_html_e( 'Author Name', 'ameron' ); ?></label>
