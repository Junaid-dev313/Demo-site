...
$logo = ameron()->get_theme_opt( 'logo_m', ['url' => get_template_directory_uri().'/assets/images/logo.png', 'id' => '' ] );
$p_menu = ameron()->get_page_opt('p_menu');
$header_css_cls = ameron()->header->get_header_css_class(['class' => '']);
?>
