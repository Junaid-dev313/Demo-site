...
if(is_singular('product')){
    $pxl_sidebar = ameron()->get_sidebar_args(['type' => 'product', 'content_col'=> '8']); // type: blog, post, page, shop, product
}else{
    $pxl_sidebar = ameron()->get_sidebar_args(['type' => 'shop', 'content_col'=> '8']); // type: blog, post, page, shop, product
}
?>
    <div class="container">
